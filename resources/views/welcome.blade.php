...
<body>
    ...
    <div id="carouselExample" class="carousel slide carousel-fade">
        <div class="carousel-inner">
            <div class="carousel-item active" style=" width: auto; margin: auto;">
                <img src="{{ asset('assets/img/img_carrusel_1.png') }}" class="d-block w-100 img-fluid"
                    alt="banner de invitacion">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('assets/img/img_carrusel_2.png') }}" class="d-block w-100 img-fluid"
                    alt="Banner de publicidad">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('assets/img/img_carrusel_3.png') }}" class="d-block w-100 img-fluid"
    ...
    <section class="container-fluid bg-body-secondary text-center">
        <div class="container p-5">
            <h2 class="text-light mb-5">Confeccionando eficiencia en cada hilo<span class="text-info"> tu aliado en
                    facturación electrónica y gestión de inventario.</span></h2>
            <div class="">
                <a href="{{ route('login') }}" role="button" class="btn btn-primary">Ingresar</a>
            </div>
        </div>
    ...
    <footer class="text-center text-white">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2023 Copyright:
            <a class="text-white" href="#">TuPagina.com</a>
        </div>
        <!-- Copyright -->
    </footer>
